...
//	}
	...
	public Service getService(String name)
	{
		...
		Debug.message("Service Cnt is " + serviceCnt);
		for (int n=0; n<serviceCnt; n++) {
			Service service = serviceList.getService(n);
			Debug.message("serviceList service name " + service.getServiceType());
		...
		for (int n=0; n<devCnt; n++) {
			...
			Debug.message("devList service name " + service.getServiceType());
			if (service != null)
				return service;
		}
