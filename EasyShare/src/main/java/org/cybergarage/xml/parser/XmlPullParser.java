				...
				case org.xmlpull.v1.XmlPullParser.START_TAG:
					{
						...
						Debug.message("namePrefix " + namePrefix + " name " + name);
						...
						for (int n=0; n<attrsLen; n++) {
							...
							Debug.message("attrname " + attrName + " attrValue " + attrValue);
				...
				case org.xmlpull.v1.XmlPullParser.TEXT:
					{
						...
						Debug.message("text value " + value);
